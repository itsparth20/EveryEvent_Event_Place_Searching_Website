...
//       window.location="http://localhost:8080/EveryEvents/googleAuth?id="+profile.getId()+'&fullName='+profile.getName()+'
	   //&givenName='+profile.getGivenName()+'&familyName='+profile.getFamilyName()+"&imageURL="+profile.getImageUrl()+"&email="+profile.getEmail();
