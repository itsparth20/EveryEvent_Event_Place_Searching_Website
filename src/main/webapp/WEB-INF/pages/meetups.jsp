      ...
      <div class="col-sm-4">
        ...
        <div class="thumbnail">
          ...
          <p>${items.venue.city }</p>
       		       <form action="http://localhost:8080/EveryEvents/searchmeetupsByIDReq?eventID=${items.event_id}" method="Post">
    ...
    <c:if test="${count%3==0}">
     ...
     <c:set var="count" value="${count+1}" scope="page"/>
        ...
        $('#showmeetuppage').on('click', function (e) {
              window.location="http://localhost:8080/EveryEvents/changePwdReq";
       })
        </script>
