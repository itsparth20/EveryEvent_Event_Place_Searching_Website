				       ...
				       ${sessionScope.displayName}
				          ...
				          <ul class="dropdown-menu">
				            ...
				            <li><a href="http://localhost:8080/EveryEvents/showMyEventsReq">EVENTS</a></li>
				 			 ...
				 			 <c:if test="${sessionScope.googleUser==NULL}">
              		            <li><a  href="http://localhost:8080/EveryEvents/logout">Log out</a></li>
				 			 </c:if>
                        </ul>
				        </li>
                            ...
                            <tr>
                                    ...
                                    <td>
                                     ...
                                     <div class="btn-group" role="group" aria-label="Password operations">
		                          		<table>
		                          		<tr>
		                          		<td> <form action="http://localhost:8080/EveryEvents/deleteUserReq?email=${items.email}" method="Post">
		                          		 	<input type="submit" class="btn btn-info" id="submit" value="Delete User" > 
		                          		 </form></td>
		                          		<td> 
		                          		    <form action="http://localhost:8080/EveryEvents/showUserReq?email=${items.email}" method="Post">
