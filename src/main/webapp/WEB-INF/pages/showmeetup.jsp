    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <c:if test="${sessionScope.userSession.role.role_name eq 'admin'}">
             ...
             <li><a href="http://localhost:8080/EveryEvents/newEvent" ><font color="#1abc9c"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create Event</font></a></li>    <li><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>
            ...
            <div class="col-sm-2" >
				       ...
				       <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>Going in Event?</b></p>
				             <a href="http://localhost:8080/EveryEvents/visitMeetupsYesByIDReq?eventID=${meetupEvent.event_id}" class="btn"><span class="glyphicon glyphicon-thumbs-up"></span> Yes</a>
                       ...
                       <div class="thumbnail text-center">
				        ...
				        <div class="thumbnail text-center">
				         <p style="    color: #d9534f;"><b>Hotel near Vanue</b></p>
				          <p><a href="http://localhost:8080/EveryEvents/placesHotelNearReq?city=${meetupEvent.venue.city}&state=${meetupEvent.venue.state}" target="_blank" class="btn">Hotels</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
				          <p style="    color: #d9534f;"><b>Restaurant near Vanue</b></p>
				          <p><a href="http://localhost:8080/EveryEvents/placesRestaurantNearReq?city=${meetupEvent.venue.city}&state=${meetupEvent.venue.state}" target="_blank" class="btn">Restaurant</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
