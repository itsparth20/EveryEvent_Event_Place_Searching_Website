  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
        ...
        <a class="navbar-brand" href="http://localhost:8080/EveryEvents/homepage" >EveryEvent</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://localhost:8080/EveryEvents/homepage">HOME</a></li>
        <li><a href="http://localhost:8080/EveryEvents/eventsReq">EVENTS</a></li>
        <li><a href="http://localhost:8080/EveryEvents/meetupsReq">MEETUPS</a></li>
        <li><a href="http://localhost:8080/EveryEvents/placesReq">PLACES</a></li>
        <c:if test="${sessionScope.userSession.role.role_name eq 'admin'}">
	         <li class="dropdown">
	          <a class="dropdown-toggle" data-toggle="dropdown" href="#">ADMIN
	          <span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="http://localhost:8080/EveryEvents/showAllUsers">USERS</a></li>
	            <li><a href="#">EVENTS</a></li>
	            <li><a href="#">GROUPS</a></li>
	          </ul>
	        </li>
        </c:if>
         <li><a href="http://localhost:8080/EveryEvents/newEvent" ><font color="#1abc9c"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create Event</font></a></li>
         ...
         <li><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>
              ...
              <c:if test="${sessionScope.userSession != NULL}">
				       ...
				       ${sessionScope.displayName}
				          <span class="caret"></span></a>
				          <ul class="dropdown-menu">
				           <li><a href="http://localhost:8080/EveryEvents/accountReq">My Account</a></li>
				            <li><a href="http://localhost:8080/EveryEvents/showMyEventsReq">EVENTS</a></li>
              		            ...
              		            <script>
              		        	      function signOut() {
			              		        ...
			              		        auth2.signOut().then(function () {
			              		          ...
			              		          window.location="http://localhost:8080/EveryEvents/logout";
			              		        });
			              		      }
              		            </script>
				 			 </c:if>
				 			 <c:if test="${sessionScope.googleUser==NULL}">
              		            <li><a data-toggle="modal"  href="http://localhost:8080/EveryEvents/logout">Log out</a></li>
				 			 </c:if>
                        </ul>
				        </li>
     	 	 ...
     	 	 <c:if test="${sessionScope.userSession==NULL}">
              		 <li> <a href="http://localhost:8080/EveryEvents/signup">SIGN UP</a></li>
             </c:if>
      </ul>
    </div>
  </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="http://www.skiheavenly.com/~/media/heavenly/images/732x260%20header%20images/events-heavenly-header.ashx" alt="New York" style="height: 690Px;">
      ...
      <div class="item">
        <img src="http://static1.squarespace.com/static/533353a3e4b0429a548a8446/t/54a78bede4b057f9e3964d76/1420266478889/lights_events_1366x768_68503.jpg" alt="Chicago" style="height: 690Px;">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="http://visualmemories.photography/wp-content/uploads/2016/02/events1.jpg" alt="Los Angeles" style="height: 690Px;">
        <div class="carousel-caption">
          <h3>Meetups</h3>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
		  ...
		  <c:if test="${sessionScope.userSession==NULL}">
        		<script>
					      function onSignIn(googleUser) {
					          ...
					          console.log("-----------------------------------------------------------");
					          window.location="http://localhost:8080/EveryEvents/googleAuth?googleId="+profile.getId()+'&fullName='+profile.getName()+'&givenName='+profile.getGivenName()+'&familyName='+profile.getFamilyName()+"&imageURL="+profile.getImageUrl()+"&email="+profile.getEmail()+"&idToken="+id_token;
          ...
          <p><a href="http://localhost:8080/EveryEvents/forgetpassword">forgot Password?</a></p>
          <c:if test="${status == 0}">
