            ...
            <div class="col-sm-2" >
				       ...
				       <div class="thumbnail text-center">
                          <p style="color: #d9534f;"><b>Going in Event?</b></p>
				             <a href="http://localhost:8080/EveryEvents/visitEventsYesByIDReq?eventID=${infoEvent.event_id}"  class="btn"><span class="glyphicon glyphicon-thumbs-up"></span> Yes</a>
                       ...
                       <div class="thumbnail text-center">
				        ...
				        <div class="thumbnail text-center">
				         <p style="    color: #d9534f;"><b>Hotel near Vanue</b></p>
				          <p><a href="http://localhost:8080/EveryEvents/placesHotelNearReq?city=${infoEvent.venue.city}&state=${infoEvent.venue.state}" target="_blank" class="btn">Hotels</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
				          <p style="    color: #d9534f;"><b>Restaurant near Vanue</b></p>
				          <p><a href="http://localhost:8080/EveryEvents/placesRestaurantNearReq?city=${infoEvent.venue.city}&state=${infoEvent.venue.state}" target="_blank" class="btn">Restaurant</a>
				          </p>
				        </div>
				        <div class="thumbnail text-center">
